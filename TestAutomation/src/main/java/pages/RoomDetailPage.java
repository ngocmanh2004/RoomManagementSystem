...
public class RoomDetailPage {
    ...
    By rentNowBtn = By.xpath("//button[contains(text(),'Đặt thuê ngay')]");
    ...
    public boolean isRentNowButtonEnabled() {
        return driver.findElement(rentNowBtn).isEnabled();
    }

    public BookingModalPage openBookingModal() {
        driver.findElement(rentNowBtn).click();
        return new BookingModalPage(driver);
    }
}
