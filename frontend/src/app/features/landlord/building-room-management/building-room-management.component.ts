...
@Component({
  selector: 'app-building-room-management',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './building-room-management.component.html',
  styleUrls: ['./building-room-management.component.css'],
})
export class BuildingRoomManagementComponent implements OnInit {
  buildingId: number = 0;
  ...
  ngOnInit(): void {
    // Lấy buildingId từ route params
    this.route.params.subscribe(params => {
      this.buildingId = +params['id'];
      this.loadBuildingInfo();
      this.loadRoomsByBuilding();
    });
    this.loadBuildings();
    this.loadAmenities();
  }
  ...
  onSubmit(): void {
    ...
    // Xóa buildingId vì backend chỉ cần building.id
